...
public void paintComponent(Graphics window) {
		...
		g2d.fillRoundRect(1100,110,200,70,10,10);
		g2d.setColor(Color.YELLOW);
		g2d.setFont(font2);
		g2d.drawString("Score: "+score,1120,160);
...
////////////////////////////////////////////////////////////////////  GAME METHODS
	...
	public void animate()
		...
		if(((xViewPoint<0) && (xViewPoint>-7500)) && ((yViewPoint<0)&&(yViewPoint>-700)) )
			{xViewPoint+=dX;yViewPoint+=dY;}
		else
			{
			if(xViewPoint<1000 && dX<0&&xViewPoint>-1000)
				{xViewPoint+=dX;}
			else if(xViewPoint<-7500&&dX>0)
				{xViewPoint+=dX;}
			...
			else if(yViewPoint<0&&dY<0&&	(xViewPoint<0) && (xViewPoint>-7500)    )
				xViewPoint+=dX;

			else if(yViewPoint>-7500&&dY>0&&	(xViewPoint<0) && (xViewPoint>-7500)    )
				xViewPoint+=dX;
