...
g2d.setColor(Color.RED);	
	...
	if(gameOver==true)
		{
		g2d.setFont(font1);
		g2d.drawString("GAME OVER",520,400);
		}
...
boolean cIn = false;
	...
	public void drawObject(Graphics g2d)
		{
		x = runner.s.getWidth()/2 + (int)(r*Math.cos(theta));
	...
	public boolean checkCollision()
		...
		if(	((	(runner.s.getWidth()/2)+(int)(spiralGame.playerRadius*Math.sin(spiralGame.dCenter))	)>x) && (		(runner.s.getWidth()/2)+(int)(spiralGame.playerRadius*Math.sin(spiralGame.dCenter)))<(x+w)	 && spiralGame.jump==false	)
			{
